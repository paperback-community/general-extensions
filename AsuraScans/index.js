...
var source = (() => {
  ...
  var require_lib2 = __commonJS({
    "node_modules/html-entities/lib/index.js"(exports) {
      ...
      function decodeEntity(entity, _a4) {
        var _b = (_a4 === void 0 ? defaultDecodeEntityOptions : _a4).level, level = _b === void 0 ? "all" : _b;
        if (!entity) {
          return "";
        }
  ...
  var parseMangaDetails = async ($2, mangaId) => {
    ...
    const titles = [(0, import_html_entities.decode)(title)];
    return {
      mangaId,
      mangaInfo: {
  ...
  var parsePopularSection = async ($2) => {
    ...
    for (const manga of $2("a", "div.flex-wrap.hidden").toArray()) {
      ...
      popularSection_Array.push({
        imageUrl: image,
        title: (0, import_html_entities.decode)(title),
        chapterId: (0, import_html_entities.decode)(subtitle),
        mangaId: id,
